<template>
  ...
  >
    ...
    <div class="menu-item px-5">
      <router-link to="/dashboard" class="menu-link px-5"> My Profile </router-link>
    </div>
    <!--end::Menu item-->

    <!--begin::Menu item-->
    <div class="menu-item px-5">
      <router-link to="/videos" class="menu-link px-5">
    ...
    >
      <router-link to="/dashboard" class="menu-link px-5">

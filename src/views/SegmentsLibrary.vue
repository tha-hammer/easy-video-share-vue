          ...
          <div class="d-flex flex-column flex-column-fluid">
            ...
            <div class="toolbar" id="kt_toolbar">
              ...
              >
                ...
                >
                  <!--begin::Title-->
                  <h1 class="d-flex text-dark fw-bold my-1 fs-3">My Segments</h1>
                  <!--end::Title-->
                ...
                <div class="d-flex align-items-center py-1">
                  <button class="btn btn-light-primary me-3" @click="router.push('/videos')">
                  ...
                  <p class="text-muted mb-4">
                    {{
                      segmentsStore.segments.length === 0
                        ? 'You have no segments yet. Upload and process videos to create segments.'
